...
######################################################################
## Gestion de variables num�riques
######################################################################
...
######################################################################
## Op�rations sur une variable num�rique
######################################################################
x[5] / 1000
#[1] 2.6
...
######################################################################
## Gestion de variables cat�gorielles
######################################################################
...
######################################################################
## Manipulation de variables cat�gorielles
######################################################################
...
######################################################################
## S�lection index�e d'observations
######################################################################
x[c(3,5)]
#[1] 2557 2600
...
######################################################################
## S�lection crit�ri�e d'observations
######################################################################
x[y < 50]
...
######################################################################
## Repr�sentation et traitement des valeurs manquantes
######################################################################
...
######################################################################
## Sauvegarde de donn�es dans un fichier externe
######################################################################
write.csv(bt, file="bt.csv")


######################################################################
## Construction d'un tableau structur� de donn�es
######################################################################
d <- data.frame(x, y, z)
names(d) <- c("poids.bébé", "poids.mère", "cig.mère")
head(d, n=3)
#poids.b�b� poids.m�re cig.m�re
#1       2523       82.7       NF
#2       2551       70.5       NF
#3       2557       47.7        F
